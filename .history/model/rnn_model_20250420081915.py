...
# Get corresponding part of the original dataframe
    test_df = df[-len(y_test):]  # Make sure this matches test set length

# Save results correctly
    save_results(test_df, y_test, predictions, scaler, f"{symbol.lower()}_rnn")
